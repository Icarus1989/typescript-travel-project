...
console.log(`Amsterdam --> flotta di ${mooveAmsterdam.flotta.length} mezz${mooveAmsterdam.flotta.length === 1 ? "o" : "i"}`);
console.log(`Milano --> flotta di ${mooveMilan.flotta.length} mezz${mooveMilan.flotta.length === 1 ? "o" : "i"}`);
console.log(`Madrid --> flotta di ${mooveMadrid.flotta.length} mezz${mooveMadrid.flotta.length === 1 ? "o" : "i"}`);
// prenotazione mezzo --->
